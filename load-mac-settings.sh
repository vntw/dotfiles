...
# Use fn key to use the special features of the F1-12 keys
...
# Save screenshots to a different directory
...
defaults write com.googlecode.iterm2.plist PrefsCustomFolder -string "/Users/ven/.dotfiles/settings/iterm2"
# Tell iTerm2 to use the custom preferences in the directory
defaults write com.googlecode.iterm2.plist LoadPrefsFromCustomFolder -bool true

# Disable saving passphrase in keychain
